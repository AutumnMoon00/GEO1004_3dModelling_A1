...
//        std::vector<Point_3> inner_ring_vertices_3 {};
        ...
        std::cout << "\t==================" << std::endl;
        // instance of DT and insert all the points
//        Triangulation cdt;
//        cdt.insert(proj_points.begin(), proj_points.end());
        // inserting all the constraints
//        cdt.insert_constraint(outer_points_2.begin(), outer_points_2.end(), close=true);

        // //////////////////////////////////
//        Triangulation cdt2;
        std::vector<Point_2> outer_points_2 {};
        for (const auto& vertex_outer: face.outer_ring) {
...
//        outer_points_2.emplace_back(outer_points_2.at(0));
