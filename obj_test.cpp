...
//                std::cout << "\n\tinside try 44!!" << std::endl;
                for (int neighbour = 0; neighbour < 3; ++neighbour) {
//                    std::cout << "\n\tinside try 55!!" << std::endl;
...
//        std::map<Point_2, int> proj_2d_to_vertex;
        ...
        for (auto fit = face.triangulation.finite_faces_begin(); fit != face.triangulation.finite_faces_end(); ++fit) {
